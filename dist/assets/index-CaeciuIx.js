 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Dn{constructor(e,t){this.bucket=e,this.path_=t}get path(){return this.path_}get isRoot(){return this.path.length===0}fullServerUrl(){const e=encodeURIComponent;return"/b/"+e(this.bucket)+"/o/"+e(this.path)}bucketOnlyServerUrl(){return"/b/"+encodeURIComponent(this.bucket)+"/o"}static makeFromBucketSpec(e,t){let i;try{i=Dn.makeFromUrl(e,t)}catch{return new Dn(e,"")}if(i.path==="")return i;throw IP(e)}static makeFromUrl(e,t){let i=null;const o="([A-Za-z0-9.\\-_]+)";function l(H){H.path.charAt(H.path.length-1)==="/"&&(H.path_=H.path_.slice(0,-1))}const c="(/(.*))?$",f=new RegExp("^gs://"+o+c,"i"),p={bucket:1,path:3};function v(H){H.path_=decodeURIComponent(H.path)}const E="v[A-Za-z0-9_]+",A=t.replace(/[.]/g,"\\."),C="(/([^?#]*).*)?$",N=new RegExp(`^https?://${A}/${E}/b/${o}/o${C}`,"i"),K={bucket:1,path:3},Q=t===lT?"(?:storage.googleapis.com|storage.cloud.google.com)":t,B="([^?#]*)",ae=new RegExp(`^https?://${Q}/${o}/${B}`,"i"),X=[{regex:f,indices:p,postModify:l},{regex:N,indices:K,postModify:v},{regex:ae,indices:{bucket:1,path:2},postModify:v}];for(let H=0;H<X.length;H++){const me=X[H],de=me.regex.exec(e);if(de){const P=de[me.indices.bucket];let S=de[me.indices.path];S||(S=""),i=new Dn(P,S),me.postModify(i);break}}if(i==null)throw TP(e);return i}}class PP{constructor(e){this.promise_=Promise.reject(e)}getPromise(){return this.promise_}cancel(e=!1){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
